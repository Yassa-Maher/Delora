...
export default function AdminCategories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await API.put(`/categories/${editing}`, fd, { headers: { 'Content-Type': 'multipart/form-data' } });
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openNew} className="btn-primary text-sm flex items-center gap-1.5 py-2 px-4"><FiPlus /> إضافة قسم</button>
      </div>
