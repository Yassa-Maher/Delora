...
import { Package, Grid, ShoppingBag, ArrowUp, DollarSign, TrendingUp, Star, Box, PieChart } from 'lucide-react';
...
export default function DashboardHome() {
  ...
  const statCards = [
    { label: 'المنتجات', value: stats.products, icon: Package, color: '#2563EB', bg: '#e8f0fe', link: '/admin/products' },
    { label: 'الأقسام', value: stats.categories, icon: Grid, color: '#7C3AED', bg: '#f0ebff', link: '/admin/categories' },
    { label: 'الطلبات', value: stats.orders, icon: ShoppingBag, color: '#EA580C', bg: '#fff4ed', link: '/admin/orders' },
    { label: 'الإيرادات', value: `${stats.revenue.toFixed(2)}`, icon: DollarSign, color: '#16A34A', bg: '#ecfdf3', link: '/admin/orders', suffix: ' ج.م' },
  ];
    ...
    <div className="animate-fadein">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 lg:col-span-2 animate-fadein-up">
          <div className="flex items-center gap-2 mb-4">
            <TrendingUp className="text-[rgb(0,166,62)]" size={20} />
