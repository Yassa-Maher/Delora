...
const seed = async () => {
    ...
    await connection.execute(
        `INSERT IGNORE INTO store_settings (key_name, key_value_ar, key_value_en, display_name_ar, display_name_en) VALUES
         ...
         ('store_email', 'delora.market@gmail.com', 'delora.market@gmail.com', 'البريد الإلكتروني', 'Store Email'),
         ('store_address', 'القاهرة', 'Cairo', 'عنوان المتجر', 'Store Address'),
         ('delivery_fee', '30', '30', 'رسوم التوصيل', 'Delivery Fee'),
         ('free_delivery_min', '200', '200', 'التوصيل المجاني عند', 'Free Delivery Min'),
         ('whatsapp_number', '201001105352', '201001105352', 'رقم الواتساب', 'WhatsApp Number'),
         ('working_hours', '9 ص - 12 ص', '9 AM - 12 AM', 'ساعات العمل', 'Working Hours'),
         ('about_us_ar', 'DELORA - وجهتك الأولى للتسوق الذكي.', 'DELORA - Your premier destination for smart shopping.', 'عن المتجر', 'About Us'),
         ('currency_symbol_ar', 'ج.م', 'EGP', 'رمز العملة', 'Currency Symbol'),
         ('copyright_text_ar', 'جميع الحقوق محفوظة', 'All rights reserved.', 'نص الحقوق', 'Copyright Text'),
         ('is_multi_language', 'true', 'true', 'دعم اللغات المتعددة', 'Multi Language')`
    );
